...
export const destinations: Destination[] = [
  {
    ...
    description: "Cruise through serene backwaters on traditional houseboats, visit lush tea plantations, and authentic Ayurvedic wellness in this tropical paradise.",
    image: keralaImg,
    price: 25999,
  ...
  },
  {
    ...
    description: "Discover pristine beaches with crystal-clear waters, dive into vibrant coral reefs, and see the untouched beauty of these enchanting islands.",
    image: andamanImg,
    price: 35999,
    ...
    sections: [
      { id: "overview", title: "Overview", content: "The Andaman Islands offer pristine beaches, turquoise waters, and some of the best diving spots in Asia. Discover untouched nature, historical sites, and vibrant marine life." },
      { id: "accommodation", title: "Accommodation", content: "From beachfront resorts to eco-friendly beach huts, enjoy island living at its finest. Options include luxury resorts in Port Blair and rustic beach camps on Havelock." },
    ],
  },
  {
    id: "ladakh",
    ...
    sections: [
      { id: "overview", title: "Overview", content: "Ladakh, the land of high passes, offers breathtaking landscapes, ancient Buddhist monasteries, and adventure at every turn. Witness the raw beauty of the Himalayas." },
      { id: "accommodation", title: "Accommodation", content: "Stay in traditional Ladakhi guesthouses, luxury camps by Pangong Lake, or boutique hotels in Leh. Enjoy local hospitality amid stunning mountain backdrops." },
    ],
  },
  {
    id: "goa",
    ...
    description: "Relax on golden beaches, visit Portuguese heritage sites, enjoy vibrant nightlife, and savor delicious seafood in India's favorite beach destination.",
    image: goaImg,
    price: 18999,
